  ...
  async beforeRegisterNodeDef(nodeType, nodeData, app) {
    if (nodeType.comfyClass === "PMLoadVideo") {
      ...
      nodeType.prototype.onNodeCreated = function() {
        ...
        let uploadWidget = this.addWidget("button", "Upload Video", "video", () => {
        ...
        // 等待翻译加载完成后更新按钮文本
        initPromise.then(() => {
          uploadWidget.label = t('uploadVideo', 'Upload Video');
        ...
        const updateVideoSource = async (filePath) => {
        ...
        if (pathWidget) {
          ...
          pathWidget.callback = async function(filename) {
            ...
            await updateVideoSource(filename);
          };
          ...
          if (pathWidget.value) {
            setTimeout(async () => {
              ...
              await updateVideoSource(pathWidget.value);
            }, 50);
          }
        }
